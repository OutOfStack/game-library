...
func (m *MockIGDBAPIClient) CompanyExists(ctx context.Context, companyName string) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIGDBAPIClientMockRecorder) CompanyExists(ctx, companyName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CompanyExists", reflect.TypeOf((*MockIGDBAPIClient)(nil).CompanyExists), ctx, companyName)
}
